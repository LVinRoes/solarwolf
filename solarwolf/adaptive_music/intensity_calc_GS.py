...
class Intensity_calc_GS:
    def __init__(self, gameplay, max_intensity=100.0):
        ...
        self.turbo_active = 0
        self.lives_left = 0
        # shield_active was removed as it is not used.
    ...
    def calculate_intensity(self):
        ...
        # Calculate the distance to the nearest enemy projectile
        ...
        # Base intensity score from the contributing factors
        ...
        # Additional score based on distance to the nearest projectile
