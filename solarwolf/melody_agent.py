...
class MelodyAgent:
    def __init__(self):
        ...
        self.phrase_library = {
            ...
            2: [
                [(69, 0.5), (74, 0.25), (72, 1.0), (72, 0.25)],
                [(72, 0.5), (69, 0.5), (76, 1.0)],
                # Zusätzliche Melodie für Stufe 2:
            ],
            3: [
                [(69, 0.5), (72, 0.5), (74, 0.5), (76, 0.5)],
                [(76, 1.0), (72, 0.5), (74, 0.5), (69, 1.0)],
                # Zusätzliche Melodie für Stufe 3:
                [(69, 0.5), (71, 0.5), (72, 0.5), (74, 0.5), (72, 0.5), (69, 0.5)]
            ],
            4: [
                [(69, 0.25), (72, 0.25), (74, 0.5), (76, 0.5), (79, 0.5)],
                [(72, 0.5), (74, 0.5), (76, 0.25), (79, 0.25), (76, 0.5), (72, 0.25)],
                # Zusätzliche Melodie für Stufe 4:
                [(69, 0.25), (72, 0.5), (74, 0.25), (76, 0.5), (74, 0.5), (72, 0.25)]
            ],
            5: [
                # Höchste Intensität – etwas mehr Bewegung, dennoch keine extremen 16tel
                [(69, 0.5), (72, 0.25), (74, 0.25), (76, 0.5), (79, 0.5)],
                [(79, 0.25), (76, 0.5), (74, 0.5), (72, 0.25), (69, 0.5)],
                # Zusätzliche Melodie für Stufe 5:
                [(69, 0.25), (72, 0.25), (74, 0.25), (76, 0.25), (79, 0.5), (76, 0.5), (72, 0.25), (69, 0.25)]
            ]
        }
